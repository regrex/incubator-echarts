...
function createSymbol(name, lineData, idx) {
  ...
  symbolPath.rotation = symbolRotate == null || isNaN(symbolRotate) ? undefined : +symbolRotate * Math.PI / 180 || 0;
...
function updateSymbolAndLabelBeforeLineUpdate() {
  ...
  if (symbolFrom) {
    ...
    if (symbolFrom.rotation == null || symbolFrom.shape && symbolFrom.shape.symbolType === 'arrow') {
  ...
  if (symbolTo) {
    ...
    if (symbolTo.rotation == null || symbolTo.shape && symbolTo.shape.symbolType === 'arrow') {
